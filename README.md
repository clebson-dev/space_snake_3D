...
- **Energia Dourada** (Rara): Bônus de velocidade (Speed Up).
- **Energia Verde** (Ultra-rara/Móvel): Alto crescimento (+2000 pontos, +20 segmentos). Fugitiva!

### Mecânicas Especiais
- **Turbo (Boost)**
  - Duração máxima: **2 segundos**
